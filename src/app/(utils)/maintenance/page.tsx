...
export const metadata: Metadata = {
  title: "Under Maintenance | Twelve Creative",
  description: "Twelve Creative is currently undergoing scheduled maintenance. We will be back shortly.",
...
export default function MaintenancePage() {
  return (
    <div className="bg-background flex min-h-[70vh] flex-col items-center justify-center px-4 py-12 text-center md:py-20">
      ...
      <p className="text-muted-foreground mt-8 text-[10px] font-bold tracking-widest uppercase">
        &copy; {new Date().getFullYear()} Twelve Creative Ltd.
      </p>
    </div>
  );
}
