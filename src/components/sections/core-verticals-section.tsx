      ...
      {shouldMountVideo && size && (
        ...
        >
          <ReactPlayer
            ...
            playsInline
            controls={false}
            // Real pixel numbers reach the YouTube provider's own iframe via
            // a patched dependency (patches/youtube-video-element.patch) —
            // see that patch for why CSS width/height alone isn't enough.
