    ...
    >
      <div className="flex gap-3 p-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-muted-foreground mt-0.5 line-clamp-1 text-[10px] font-medium">
      ...
      <div className="border-border bg-muted/40 mt-auto flex items-center justify-between border-t px-3 py-2">
        {doctor.fee ? (
          ...
          <span className="text-muted-foreground text-[10px]">Fee varies</span>
        )}
      ...
      <div className="flex gap-3 p-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-0.5 flex items-center gap-1">
            ...
            />
            <p className="text-muted-foreground line-clamp-1 text-[10px] font-medium">
              {hospital.city}
            </p>
          </div>
