  ...
  return (
    ...
    >
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[24rem_1fr] lg:gap-8">
          {/* Left: Founder CTA card */}
          <Card className="from-primary/10 to-primary/3 ring-primary/20 relative overflow-hidden bg-linear-to-br p-0 ring-1 lg:sticky lg:top-28 lg:self-start">
            <div
              aria-hidden
